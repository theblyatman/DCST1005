...
try {
    ...
    $env:SUBSCRIPTION_ID = "11068509-2c3f-4cfc-9095-c5c618cd25d6";
    $env:RESOURCE_GROUP = "nr04-rg-infraitsec-arc";
    $env:TENANT_ID = "7ce49715-4cc5-4119-aac0-8bd469a050e8";
    $env:LOCATION = "norwayeast";
    $env:AUTH_TYPE = "token";
    $env:CORRELATION_ID = "4841c4ce-2086-43fc-9c84-b5dd9eda6d58";
    ...
    # Run connect command
    & "$env:ProgramW6432\AzureConnectedMachineAgent\azcmagent.exe" connect --resource-group "$env:RESOURCE_GROUP" --tenant-id "$env:TENANT_ID" --location "$env:LOCATION" --resource-name "DC1-nr04" --subscription-id "$env:SUBSCRIPTION_ID" --cloud "$env:CLOUD" --tags 'Datacenter=NTNU,City=Trondheim,CountryOrRegion=Norway,Owner=nikitar@stud.ntnu.no,Project=infrait-lab,CostCenter=lab,Comments=Testing Azure Arc' --correlation-id "$env:CORRELATION_ID";
}
catch {
